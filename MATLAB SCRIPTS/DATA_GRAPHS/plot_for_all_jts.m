function [] = plot_for_all_jts(x_data, y_data_0, y_data_1, y_data_2, y_data_3, y_data_4, y_data_5, ...
    ...
    h4 = plot(x_data, y_data_4);
    h5 = plot(x_data, y_data_5);
    ...
    legend([h0, h1, h2, h3, h4, h5],LEGENDS);
