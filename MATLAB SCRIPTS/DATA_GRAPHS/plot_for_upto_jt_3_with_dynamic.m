function [] = plot_for_upto_jt_3_with_dynamic(x_data, y_data_0, y_data_1, y_data_2, y_data_3, y_data_4, y_data_5, ...
    ...
    y_values = g_y; %=[0:Y_STEP_SIZE:MAX_Y_AXIS]; % user defined grid Y [start:spaces:end]
    chi_critical_1 = 30.*ones(length(y_values));
    chi_critical_2 = 48.*ones(length(y_values));
%     plot(chi_critical_1, y_values, '--k');
%     plot(chi_critical_2, y_values, '--k');
