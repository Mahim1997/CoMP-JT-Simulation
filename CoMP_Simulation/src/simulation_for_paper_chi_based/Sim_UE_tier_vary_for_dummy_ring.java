...
public class Sim_UE_tier_vary_for_dummy_ring {

    private static boolean IS_CONVENTIONAL = false;
    private final SimulationParameters simParams;

    public Sim_UE_tier_vary_for_dummy_ring(SimulationParameters simParams) {
        this.simParams = simParams;
    }

    public void runSimulation() {
        Main.PREV_MODE_JT = Main.JT_MODE;
        for (int JT = Main.JT_INITIAL; JT <= Main.JT_FINAL; JT++) {
...
//                Main.JT_MODE = Main.JT_CONVENTIONAL;
            ...
            for (int tier = Main.TIER_START; tier <= Main.TIER_FINAL; tier++) {
                simParams.tier = tier;
                run_UE_Tavg_vs_chi_tier(tier);
            }
        }
    }

    public void run_UE_Tavg_vs_chi_tier(int tier) {
